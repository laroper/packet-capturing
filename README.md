...
**Description:** I used tcpdump to capture network traffic on a Linux virtual machine. I saved the captured data in a packet capture (pcap) file and then analyzed the contents to focus on specific types of traffic.
